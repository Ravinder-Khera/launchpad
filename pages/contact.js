                                    ...
                                    <div className="row">
                                        <div className="col-12 col-md-6">
                                            <div className="mb-3">
                                                ...
                                                style={{background:'transparent'}} id="contactName" placeholder="Full name"
                                                    name="firstname" />
                                            </div>
                                        </div>
                                        <div className="col-12 col-md-6">
                                            <div className="mb-3">
                                                ...
                                                <input type="email" className="form-control border-white" name="email" style={{background:'transparent'}}
